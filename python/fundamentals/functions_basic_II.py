...
# # Print how many values this is and then return the new list. If the list has less 
...
# # and value. The function should create and return a list whose length is equal to 
